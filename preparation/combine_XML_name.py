...
for file_seq in file_seqs:
    folder_path = fr'C:\Users\liangzheng\PycharmProjects\YOLOX-main\datasets\HIE\Annotations\{file_seq}'
    ...
    for filename in os.listdir(folder_path):
        ...
        if os.path.isfile(file_path):
            ...
            if not filename.startswith(folder_name + '_'):
                standardize = f"{int(file_name):06d}{file_extension}"
                new_filename = folder_name + '_' + 'frame'+ '_' + standardize
